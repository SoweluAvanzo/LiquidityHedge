...
import { StateStore } from "../src/event-audit/store";
import { OffchainLhProtocol } from "../src/index";
import { DEFAULT_TEMPLATE, DEFAULT_POOL_CONFIG } from "../src/config/templates";
...
export function makePool(overrides?: Partial<PoolState>): PoolState {
  return {
    ...
    premiumFloorUsdc: LEGACY_DEFAULT_PREMIUM_FLOOR_USDC,
